	...
	if(0 != tag)
	{
		...
		/*	InDatabaseADOQuery->Close();
			...
			if(ADOQuery1->RecordCount > 1)
			{
                ...
                cxTextEdit18->Text = ADOQuery1->FieldByName("KH")->AsInteger;
				...
				cxTextEdit17->Text = 0;//ADOQuery1->FieldByName("SF_YE")->AsFloat;
                cxTextEdit21->Text = ADOQuery1->FieldByName("FK")->AsInteger;
                fks = ADOQuery1->FieldByName("FK")->AsInteger;
                hfs = ADOQuery1->FieldByName("HF")->AsInteger;
			}
                ...
                if(LaunchNewCard)
                {
                    ...
                    //写FK与HF到(n+1)*4+1
                        ...
                        tmpsql = tmpsql+":SFZH,:BM,:BZ,:ZB,:ZW,:JB,:RQ,:TKRQ,:YJ,:TYJ,"+
                                        ...
                                        ":SF_KL,:USERNAME,:YW,:TKCB,:BKCB,:TKOperator,:FK,:HF)";
                 ...
                 /*       ADOQuery2->Close();
                        ...
                        if(!ADOQuery2->IsEmpty())
                        {
                            ...
                            ADOQuery3->Parameters->ParamByName("FK")->Value = fks;
                            ADOQuery3->Parameters->ParamByName("HF")->Value = hfs;
                            ADOQuery3->ExecSQL();
                            ADOQuery3->Close();
                        }          */
                        ...
                        ADOQuery2->FieldByName("FK")->AsInteger = fks+1;
                        ADOQuery2->Post();
...
void __fastcall TResendLostCardnewFRM::FormShow(TObject *Sender)
{
	cxTextEdit21->Text = "";
}
//---------------------------------------------------------------------------
