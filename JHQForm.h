...
//---------------------------------------------------------------------------
class TJHQFrm : public TForm
{
__published:	// IDE-managed Components
	TcxGroupBox *cxGroupBox1;
	TcxLabel *cxLabel4;
	TcxDateEdit *JHBeginDateEdit;
	TcxLabel *cxLabel3;
	TcxDateEdit *JHEndDateEdit;
	TcxButton *QueryBTN;
	...
	TfrxReport *frxJHTJReport;
	TcxComboBox *JHComboBox;
	TcxLabel *cxLabel1;
	void __fastcall CTComboBoxKeyPress(TObject *Sender, wchar_t &Key);
	void __fastcall FormShow(TObject *Sender);
	void __fastcall JHComboBoxEnter(TObject *Sender);
...
public:		// User declarations
	__fastcall TJHQFrm(TComponent* Owner);
    String BFstarttime;
    String BFendtime;
    String LHstarttime;
    String LHendtime;
