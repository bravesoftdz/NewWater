...
//
//      void __fastcall TXFTJZHExportThread::UpdateCaption()
//      {
//        Form1->Caption = "Updated in a thread";
//      }
//---------------------------------------------------------------------------

__fastcall TXFTJZHExportThread::TXFTJZHExportThread(bool CreateSuspended,
...
//---------------------------------------------------------------------------
void __fastcall TXFTJZHExportThread::Execute()
{
    ...
    Templatepath = path + "\\ExportXLSTemplate\\XFTJZHMXTemplate.xlt";
