...
void __fastcall TGSExportThread::Execute()
{
	...
	{
		MessageBox(GSQFrm->Handle, "错误：您的系统中可能没有安装Excel！", "Error in launch Excel!", MB_OK|MB_ICONERROR);
    ...
    MessageBox(GSQFrm->Handle, "数据已完成导出！", "Successfully!", MB_OK|MB_ICONINFORMATION);
