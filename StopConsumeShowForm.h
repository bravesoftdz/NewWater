...
#ifndef StopConsumeShowFormH
#define StopConsumeShowFormH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TStopConsumeShowFRM : public TForm
{
...
public:		// User declarations
	__fastcall TStopConsumeShowFRM(TComponent* Owner);
    String checktagstr;
    String CZYStr;
};
//---------------------------------------------------------------------------
extern PACKAGE TStopConsumeShowFRM *StopConsumeShowFRM;
//---------------------------------------------------------------------------
#endif
