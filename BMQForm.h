...
#include "Comobj.hpp"
//---------------------------------------------------------------------------
class TBMQFrm : public TForm
{
__published:	// IDE-managed Components
	TcxGroupBox *cxGroupBox1;
	TcxLabel *cxLabel4;
	TcxDateEdit *BMBeginDateEdit;
	TcxLabel *cxLabel3;
	TcxDateEdit *BMEndDateEdit;
	TcxButton *QueryBTN;
...
public:		// User declarations
	__fastcall TBMQFrm(TComponent* Owner);
    String BFstarttime;
    String BFendtime;
    String LHstarttime;
    String LHendtime;
